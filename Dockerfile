...
LABEL maintainer="Benjamin Dev"

ENV DJANGO_SETTINGS_MODULE bcloud_registry.settings.production
...
# Configure Nginx
RUN ln -s /code/conf/nginx.conf /etc/nginx/sites-enabled/bcloud_registry
